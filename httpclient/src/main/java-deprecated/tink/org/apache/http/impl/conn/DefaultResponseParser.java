...
package tink.org.apache.http.impl.conn;
...
import tink.org.apache.http.impl.io.AbstractMessageParser;
 ...
 * class:
 * <ul>
 *  <li>{@link tink.org.apache.http.params.CoreConnectionPNames#MAX_HEADER_COUNT}</li>
 *  <li>{@link tink.org.apache.http.params.CoreConnectionPNames#MAX_LINE_LENGTH}</li>
 *  <li>{@link tink.org.apache.http.conn.params.ConnConnectionPNames#MAX_STATUS_LINE_GARBAGE}</li>
 * </ul>
 *
 * @since 4.0
 *
...
public class DefaultResponseParser extends AbstractMessageParser<HttpMessage> {
    ...
    protected int getMaxGarbageLines(final HttpParams params) {
        return params.getIntParameter(
                tink.org.apache.http.conn.params.ConnConnectionPNames.MAX_STATUS_LINE_GARBAGE,
                Integer.MAX_VALUE);
    }
