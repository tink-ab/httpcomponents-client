 ...
 *
 * @deprecated (4.4) use {@link tink.org.apache.http.conn.util.PublicSuffixListParser}.
 *
 * @since 4.0
 */
...
public class PublicSuffixListParser {
    ...
    private final tink.org.apache.http.conn.util.PublicSuffixListParser parser;

    PublicSuffixListParser(final PublicSuffixFilter filter) {
        this.filter = filter;
        this.parser = new tink.org.apache.http.conn.util.PublicSuffixListParser();
    }
